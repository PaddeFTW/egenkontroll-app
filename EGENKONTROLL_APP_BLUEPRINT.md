...
**Kodstatus:** Ingen kod ska skrivas innan denna blueprint är godkänd.
...
7. Ej godkända och ej kontrollerade punkter bör kräva förklaring.
...
## 23. Beslut som krävs före kodstart

### Beslut 1 – Första innehållsversion

**Rekommendation:** Alla 11 huvudmallar samt tom mall ingår i v1.0.

### Beslut 2 – Kommentar vid negativt resultat

**Rekommendation:** Kommentar krävs vid Ej godkänd och Ej kontrollerad.

### Beslut 3 – Signering

**Rekommendation:** Namn, bekräftelse och tidsstämpel används. Ingen avancerad e-signering.

### Beslut 4 – Bilder

**Rekommendation:** Fotouppladdning väntar till v1.1. Kontrollpunkten “Fotodokumentation utförd” finns kvar som vanlig punkt.

### Beslut 5 – Granskning

**Rekommendation:** Enkel kontrollansvarig-signering ingår, men inget avancerat godkännandeflöde.

### Beslut 6 – Åtkomst

**Rekommendation:** Kärnappen byggs oberoende av betalning. Produktionsinloggning beslutas separat före lansering.
